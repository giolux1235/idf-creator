...
"""
    ...
    def _generate_vav_system(self, zone_name: str, sizing_params: Dict, 
        ...
        cooling_schedule = {
            ...
            'schedule_type_limits_name': 'AnyNumber',
            'hourly_value': 13.5  # Cooling supply air temp (13.5°C = 56°F) - increased from 13.0°C to prevent extreme cold outlet temperatures that cause Enthalpy warnings
        }
        ...
        min_airflow_for_ratio = autosized_capacity * 4.65e-5  # Increase from 4.62e-5 to 4.65e-5 to reduce Enthalpy warnings (target: reduce from 5x to fewer)
